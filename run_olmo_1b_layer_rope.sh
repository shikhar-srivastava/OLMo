#!/bin/bash
#
# Run OLMo 1B training on 4 GPUs with the LayerRoPE feature enabled.
...
RUN_NAME="OLMo-1B-layer-rope-${variant}-a${alpha_init}-b${beta_init}-ar${alpha_rot_init}-br${beta_rot_init}-bf${rope_base_freq}_nfp32_wd0"
