#!/bin/bash
#
# Run OLMo 300M training on 4 GPUs with the LayerRoPE feature enabled.
...
RUN_NAME="OLMo-300M-layer-rope-${variant}-a${alpha_init}-b${beta_init}-ar${alpha_rot_init}-br${beta_rot_init}-bf${rope_base_freq}_nfp32_wd0"
...
echo "=========================================="
echo "OLMo 300M LayerRoPE training on 4 GPUs"
echo "=========================================="
